System.register(['@angular/core', '@angular/http', 'rxjs/add/operator/map'], function(exports_1, context_1) {
    ...
    return {
        setters:[
            ...
            function (_1) {}],
        execute: function() {
            ProductItemsService = class ProductItemsService {
                /**
                 *
                 */
                constructor(http) {
            ...
            ProductItemsService = __decorate([
                core_1.Injectable(), 
                __metadata('design:paramtypes', [http_1.Http])
            ], ProductItemsService);
            exports_1("ProductItemsService", ProductItemsService);
        }
    }
});
//# sourceMappingURL=service.product-items.js.map